				...
				{this.state.showFileOptions && (
					<div id="popupBG">
						...
						{this.state.showOpsChildren == "files" && (
							<div className="popupCont">
								<div style={{ fontWeight: "bold" }}>v1.7.3</div>
								<button
